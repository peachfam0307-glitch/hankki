...
export const FOOD_ICON_GROUPS = [
  // ── 🇰🇷 한식은 «무엇을 만들었나» 로 쪼갠다 ──
  { label: '밥', items: ['fe_342', 'fe_354', 'fe_371', 'fe_373', 'fe_315', 'fe_307','fe_289', 'fe_290', 'fe_217', 'fe_229', 'fe_246', 'fe_167', 'fe_169', 'fe_170', 'fe_176', 'fe_178', 'fe_182', 'fe_189', 'fe_97', 'fe_99', 'fe_109', 'fe_132', 'fh_k01', 'fe_32', 'fe_20', 'fe_04', 'fe_67', 'fe_74', 'fe_21', 'fe_01', 'fe_02', 'fe_03', 'fe_16', 'fe_63', 'fe_06', 'fe_07'] },
  { label: '국·탕·찌개', items: ['fe_335', 'fe_336', 'fe_337', 'fe_338', 'fe_339', 'fe_340', 'fe_341', 'fe_345', 'fe_346', 'fe_359', 'fe_314', 'fe_316', 'fe_318', 'fe_284','fe_261', 'fe_262', 'fe_281', 'fe_210', 'fe_211', 'fe_212', 'fe_213', 'fe_214', 'fe_215', 'fe_216', 'fe_220', 'fe_221', 'fe_234', 'fe_159', 'fe_166', 'fe_183', 'fe_187', 'fe_141', 'fe_148', 'fe_150', 'fe_151', 'fe_152', 'fe_114', 'fe_123', 'fe_133', 'fh_k02', 'fh_k04', 'fh_k05', 'fh_k06', 'fh_k07', 'fh_k08', 'fh_k09', 'fh_k10', 'fe_28', 'fe_29', 'fe_30', 'fe_31', 'fe_13', 'fe_79', 'fe_80', 'fb_b02'] },
  { label: '면', items: ['fe_343', 'fe_344', 'fe_356', 'fe_320', 'fe_297','fe_298', 'fe_265', 'fe_276', 'fe_277', 'fe_204', 'fe_218', 'fe_219', 'fe_155', 'fe_122', 'fh_k25', 'fh_k26', 'fh_k23', 'fe_18', 'fe_37', 'fe_38', 'fe_81', 'fh_k16'] },
  { label: '구이·튀김', items: ['fe_331', 'fe_333', 'fe_334', 'fe_372', 'fe_375', 'fe_376', 'fe_317', 'fe_310','fe_305', 'fe_287', 'fe_295', 'fe_285', 'fe_263', 'fe_206', 'fe_208', 'fe_209', 'fe_247', 'fe_249', 'fe_250', 'fe_251', 'fe_157', 'fe_162', 'fe_163', 'fe_173', 'fe_180', 'fe_198', 'fe_199', 'fe_137', 'fe_100', 'fe_101', 'fe_107', 'fe_119', 'fe_131', 'fh_k14', 'fh_k15', 'fh_k18', 'fh_k20', 'fh_k29', 'fe_69', 'fe_65', 'fh_k21'] },
  ...
  { label: '회·수육', items: ['fe_360', 'fe_374', 'fe_322', 'fe_323', 'fe_324', 'fe_72','fe_136', 'fe_23', 'fe_22', 'fe_125'] },
  // ── 🌍 외국 음식은 나라로 ──
  { label: '양식', items: ['fe_321', 'fe_327', 'fe_266','fe_267', 'fe_270', 'fe_275', 'fe_168', 'fe_188', 'fe_127', 'fe_24', 'fe_26', 'fe_27', 'fe_42', 'fe_43', 'fe_52', 'fe_53', 'fe_73', 'fe_86', 'fe_87', 'fe_88', 'fe_08', 'fe_05', 'fy_y02', 'fy_y03', 'fy_y04', 'fy_y05', 'fy_y06', 'fy_y07', 'fy_y08', 'fy_y09', 'fy_y10', 'fy_y11', 'fy_y12', 'fy_y14', 'fy_yng02'] },
  ...
  { label: '빵·디저트·음료', items: ['fe_368', 'fe_369', 'fe_370', 'fe_311', 'fe_312', 'fe_264', 'fe_269', 'fe_244', 'fe_245', 'fe_186', 'fe_196', 'fe_82', 'fe_83', 'fe_84', 'fe_85', 'fe_49', 'fe_50', 'fe_51', 'fe_39', 'fe_40', 'fe_41', 'fe_17', 'fe_19', 'fe_93', 'fe_94', 'fe_15', 'fb_b09', 'fy_y13'] },
...
const ICON_RULES = [
  ...
  [['코울슬로', '콜슬로', '양배추샐러드'], 'fe_294'],
  [['오징어감자전', '오징어 감자전'], 'fe_295'],
  [['콘샐러드', '콘 샐러드', '옥수수샐러드'], 'fe_296'],
  ...
  [['항정살간장조림', '항정살 간장조림', '항정살조림'], 'fe_308'],
  [['닭고기데리야끼조림', '데리야끼조림', '닭데리야끼', '닭고기 데리야끼'], 'fe_309'],
  [['뼈없는양념돼지갈비구이', '양념돼지갈비구이', '뼈없는돼지갈비', '돼지갈비구이'], 'fe_310'],
  [['오이샌드위치', '오이 샌드위치'], 'fe_311'],
  [['오픈샌드위치', '오픈 샌드위치'], 'fe_312'],
  [['백순대볶음', '백순대', '순대볶음'], 'fe_313'],
  ...
  [['팽이버섯베이컨전', '팽이버섯 베이컨전', '팽이버섯베이컨', '베이컨전'], 'fe_317'],
  ...
  [['알배추전'], 'fe_375'],
  [['지코바치킨'], 'fe_376'],
  [['소스 모둠 셋', '소스모둠셋'], 'fe_377'],
  [['양념 모둠 셋', '양념모둠셋'], 'fe_378'],
  [['샐러드소스 모둠 셋', '샐러드소스모둠셋'], 'fe_379'],
  [['오이무침'], 'fe_383'],
  [['오이탕탕이'], 'fe_384'],
  [['부추무침'], 'fe_385'],
  [['파절이'], 'fe_386'],
  ...
  [['얼큰샤브칼국수', '얼큰 샤브 칼국수', '샤브칼국수', '샤브 칼국수'], 'fe_320'],
  [['원팬크림파스타', '원팬 크림 파스타'], 'fe_321'],
  [['양지수육', '양지 수육'], 'fe_322'],
  [['항정수육', '항정살수육', '항정 수육'], 'fe_323'],
  [['항정삼합', '항정살삼합', '항정 삼합'], 'fe_324'],
  [['묵은지볶음', '묵은지 볶음'], 'fe_325'],
  [['고등어묵은지조림', '고등어 묵은지조림'], 'fe_326'],
  [['뚝배기파스타', '뚝배기 파스타'], 'fe_327'],
  [['꽃게탕', '꽃게찌개'], 'fe_261'],
  [['전찌개', '전골찌개'], 'fe_262'],
