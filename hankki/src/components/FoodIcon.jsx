...
export const FOOD_ICON_GROUPS = [
  // ── 🇰🇷 한식은 «무엇을 만들었나» 로 쪼갠다 ──
  { label: '밥', items: ['fe_97', 'fe_99', 'fe_109', 'fe_132', 'fh_k01', 'fe_32', 'fe_20', 'fe_04', 'fe_67', 'fe_74', 'fe_21', 'fe_01', 'fe_02', 'fe_03', 'fe_16', 'fe_63', 'fe_06', 'fe_07'] },
  ...
  { label: '면', items: ['fe_122', 'fh_k25', 'fh_k26', 'fh_k23', 'fe_18', 'fe_37', 'fe_38', 'fe_81', 'fh_k16'] },
  { label: '구이·튀김', items: ['fe_100', 'fe_101', 'fe_107', 'fe_119', 'fe_131', 'fh_k14', 'fh_k15', 'fh_k18', 'fh_k20', 'fh_k29', 'fe_69', 'fe_65', 'fh_k21'] },
  // ⭐ 2026-08-02 신설 — v9.38 에 조리법 축을 세울 때 «날것»과 «삶음»이 빠져 있었다.
  //    그래서 회·육회·대구뭉티기·수육이 「구이·튀김」에 얹혀 있었다(창업자 지적).
  { label: '회·수육', items: ['fe_72', 'fe_23', 'fe_22', 'fe_125'] },
  { label: '볶음·조림', items: ['fe_117', 'fe_118', 'fe_129', 'fh_k11', 'fh_k12', 'fh_k13', 'fh_k19', 'fh_k34', 'fh_htj13', 'fe_25', 'fe_75', 'fe_34', 'fe_35', 'fe_10', 'fe_70', 'fe_64', 'fe_66'] },
  { label: '반찬·나물·김치', items: ['fe_102', 'fe_104', 'fe_105', 'fe_108', 'fe_110', 'fe_111', 'fe_112', 'fe_113', 'fe_116', 'fe_120', 'fe_124', 'fe_128', 'fe_130', 'fh_k32', 'fh_k33', 'fh_k35', 'fh_k17', 'fe_11', 'fe_12', 'fe_14', 'fe_36', 'fe_71', 'fe_95', 'fe_96', 'fe_76', 'fe_77', 'fe_78', 'fe_68'] },
