...
export default function PantryView() {
  ...
  return (
    <div className="fade">
      ...
      {/* 🧾 ⛔⛔ **[2026-08-20] 여기를 「영수증만 찍으면 저절로」로 고쳤다가 «되돌렸다».**
          📮 창업자 = *"네가 냉장고가 약하다고 해서.. 탭 개선 말한거였거든"*
             → 「영수증으로 한 번에 들어간다를 아는 사람이 없다」를 풀려던 것이었다.
          ⭐⭐ 그런데 **실물을 열어보고 되돌렸다**(절대원칙 21) — 이 화면엔 영수증 얘기가 «이미 셋»이다:
             ⑴ 「영수증 (베타)」 버튼 ⑵ 「갤러리에서 영수증 고르기」 ⑶ 「영수증은 사진에 따라 인식률이 달라요」
             여기에 넷째를 얹으면 **잔소리가 된다.**
          ⛔ 게다가 맨 위 `pantry-lead` 는 *"재료를 «넣어두면»…"* 이라 **한 화면에서 말이 갈렸다.**
          ⭐⭐ **진짜 값 있는 자리는 여기가 아니라 「코치마크」였다**(`ShopScreen.jsx`) —
             이 화면에 «온» 사람은 버튼을 이미 본다. 못 보는 사람은 **여기까지 안 온 사람**이고,
             코치는 장보기 탭 «첫 방문»에 뜨니 **오기 전에** 알릴 수 있는 유일한 자리다.
          📌 「말을 고친다」가 맞았고, **「어느 화면의 말인가」를 틀렸다.** */}
