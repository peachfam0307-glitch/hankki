  ...
  return (
    <div className="fade">
      ...
      {/* 🔑🔑 [창업자 2026-09-04] **빨간 경고 두 줄 → 열쇠 그림 한 칸**
          ...
          ⭐⭐ **왜 빨간색을 걷었나** — 빨간 세로줄 ＋ 900 굵기 ＋ `--danger` 는 앱 안에서
             «잘못됐다»를 뜻하는 옷이다. 그런데 이 줄은 **잘못된 게 아니라 값을 알려주는 줄**이다.
             📌 겁을 주니까 「구구절절」이 더 길게 느껴진다 — 색이 문제의 절반이었다.
          ✅ 열쇠 «그림»이 빨간색보다 눈에 잘 띄고, 무슨 뜻인지도 한 번에 읽힌다.

          🔢 두 줄 → 한 줄 (54자 → 34자)
             전 = 「영수증 1장에 열쇠 1개를 써요」 ＋ 「영수증은 사진에 따라 인식률이 달라요 ·
                   안 되면 ＋재료 담기로 직접 넣어도 돼요.」
             후 = 「영수증 1장에 열쇠 1개 · 안 되면 ＋재료 담기로 직접 넣어도 돼요」
      ...
      <div style={{
        ...
        <div style={{ fontSize: 16, color: 'var(--text-sub)', lineHeight: 1.5 }}>
          <b style={{ color: 'var(--brown)', fontWeight: 800 }}>영수증 1장에 {keyCount(1)}</b>
