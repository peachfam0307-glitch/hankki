      ...
      <div className="sheet-mask" onClick={onClose}>
        ...
        >
          ...
          <div style={{
            ...
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 5, fontSize: 14, fontWeight: 900, color: 'var(--brown)', letterSpacing: '0.06em' }}>
            ...
            <div className="t-sub" style={{ fontSize: 14.5, marginTop: 3 }}>{h.sub}</div>
          ...
          <div style={{ padding: '13px 18px 0', display: 'flex', flexWrap: 'wrap', gap: 6, justifyContent: 'center' }}>
            {items.map((it, i) => (
              <span key={i} style={{
                fontSize: 14, fontWeight: 800, color: 'var(--text)', background: 'var(--cream)',
          ...
          {h.debut && (
            <div style={{ padding: '11px 18px 0', textAlign: 'center' }}>
              <span style={{ fontSize: 14.5, fontWeight: 800, color: 'var(--brown)' }}>
                {h.debut}이 처음 놀러 왔어요
              </span>
            </div>
          )}
          ...
          <div style={{ padding: '16px 18px 4px', display: 'flex', flexDirection: 'column', gap: 6 }}>
            <button
              className="press"
              onClick={onOpenNews}
              style={{ width: '100%', padding: '14px', borderRadius: 15, border: 'none', background: 'var(--brown)', color: '#fff', fontSize: 16, fontWeight: 800 }}
            >
              구경하기
            </button>
            ...
            <button
              className="press"
              onClick={onClose}
              style={{ width: '100%', padding: '11px', borderRadius: 14, border: 'none', background: 'transparent', color: 'var(--text-sub)', fontSize: 15, fontWeight: 700 }}
            >
              닫기
            </button>
          </div>
