...
// 🧾 원재료 덩이 — 시트«와» 카드(더보기로 펼친 자리) «둘 다» 이걸 그린다.
//   📮 창업자 2026-09-17 = *"지금 네가 반영한게 설명아래 펼쳐지게 한다고 난 알고있는데 아이콘을 눌러야뜬다고"*
//   → 창업자가 아는 모양 = 「더보기」를 누르면 설명 «아래»에 원재료가 같이 펼쳐진다. 시트는 그대로 두고 카드에도 붙인다.
//   ⛔ 두 벌로 베끼지 않는다 — 한 곳이 낡으면 반드시 갈린다(2026-09-12 사고). 값이 없으면 아무것도 안 그린다.
