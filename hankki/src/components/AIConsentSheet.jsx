...
//
// ✂️✂️ [창업자 2026-09-13] *"이구구절절멘트뭐야"* → **글자만 절반으로 줄였다(ⓑ).**
//   ⛔⛔ **네 줄(무엇을·어디로·왜·보관)은 «그대로» 둔다** — 이건 안내문이 아니라 «법적 고지»다.
//      한 줄로 뭉치면 애플 5.1.2(i) 가 짚는 셋이 사라져 그대로 반려 사유가 된다(위 머리말 근거).
//      📮 창업자 제안 = *"AI읽기를 사용하려면 열쇠를 사용해야해요 정도로"* → 그건 «다른 자리»의 말이라
//         여기선 못 쓴다고 말하고 ⓑ(글자 줄이기)로 합의했다.
//   ⭐ 줄인 방식 = «없애기»가 아니라 «군더더기 빼기» — 뜻은 한 글자도 안 줄었다:
//      「지금 정리하는 레시피의 글자, 그리고 사진이 있으면 그 사진 한 장」 → 「레시피 글자와 사진 1장」
//      「한끼 중계 서버를 거쳐 … (미국 · 언어·이미지 모델)」 → 「…(미국)」
//      🔢 실측 = 네 줄이 폰에서 «두 줄씩 접히던 것»이 한 줄씩으로 줄었다(그게 길어 보이던 진짜 이유다).
//   ⛔ 「접어두기」(ⓐ)는 «안 했다» — 접어도 애플이 인정하는지 «확인하지 못했다».
//      재심사 중에 새 위험을 만들지 않는다. 확인이 되면 그때 다시 본다.
        ...
        <div className="sheet" onClick={(e) => e.stopPropagation()} style={{ paddingBottom: 22 }}>
          ...
          <div style={{ padding: '2px 16px 0' }}>
            ...
            <div style={{ background: 'var(--cream)', borderRadius: 12, padding: '13px 15px', fontSize: 14.5, lineHeight: 1.85, whiteSpace: 'pre-line' }}>
              · <b>무엇을</b> — 레시피 글자와 사진 1장{'\n'}
              · <b>어디로</b> — <b>Cloudflare Workers AI</b>(미국){'\n'}
              · <b>왜</b> — 재료·순서를 알아보기 쉽게{'\n'}
              · <b>보관</b> — <b>1시간</b> 뒤 지워요 · 사진은 저장 안 해요
            </div>
            <div className="t-sub" style={{ fontSize: 13.5, lineHeight: 1.6, margin: '10px 2px 14px' }}>
              「사용 안 함」을 골라도 레시피는 그대로 저장돼요. 언제든 <b>설정</b>에서 바꿀 수 있어요.
            </div>
