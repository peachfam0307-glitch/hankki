...
//    · 이 창(홈의 「한 줄 남기기」) = **메모 ＋ 별점.** 사진은 없다
//    · `DiaryEntrySheet`(일기 탭·레시피 상세) = 요리 기록 전체(별점·사진·메모) — **그대로 둔다**
//    ⛔ 뺏는 게 아니다. 쓰고 싶은 사람은 그 자리에서 그대로 쓴다.
//
// ⛔⛔ [2026-08-20 정정] 이 줄이 «메모 한 줄만 · 별점·사진 없음» 이라고 적혀 있었는데 **틀렸다** —
//    아래 74줄에 별점(`<Stars>`)이 «있다». 말과 코드가 갈려 있었다.
//    📮 창업자 = *"**별점은 좋다고 생각해(네가 안된다고 해서 안되는 줄)**"*
//    ⭐ 별점을 뺀 게 아니라 **자리를 낮췄다** — 메모 «아래»에 작게(24px). 「한 줄」이 주인공이고 별은 곁들이다.
//    📌 주석이 코드보다 낡으면 «주석을 근거로» 다음 판단을 하게 된다. 정해지면 그 자리에서 고친다.
//
