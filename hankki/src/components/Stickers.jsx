...
export const STICKER_GROUPS = [
  ...
  //   ⚠️⚠️ **또 같은 실수를 했다 — 흰 판 버전을 '겹친다'고 빼버렸다.** 창업자 폰 제보 2026-07-30
  //   *"기본프레임 투명 이래ㅋㅋ 못씀ㅋㅋ"* — 11컷 중 **8컷이 속이 뚫린 것**이라, 표지에 여러 장
  //   얹으면 뒤가 다 비쳐 선만 엉켰다. **같은 모양이어도 속이 뚫린 것과 흰 판은 쓰임이 다르다:**
  //   뚫린 것 = 사진을 감싼다 / 흰 판 = 그 위에 글씨를 쓰거나 배경을 가린다.
  //   → 뺐던 흰 판 4컷(`i01` 아치·`a02` 물결·`i05` 캡슐·`i08` 팔각)을 되살려 **모양마다 짝**을 맞췄다.
  //   📌 오늘 리컬러 때와 **똑같은 실수**다(모양만 보고 뺐다) → 규칙: **빼기 전에 쓰임이 다른지 본다.**
  //   순서 = 모양끼리 짝지어 나란히(뚫림·흰판이 붙어 있어 고를 때 비교된다).
  { key: 'deco_pf_bold', tab: 'frame', label: '기본', items: ['pf_f01', 'pf_i01', 'pf_f02', 'pf_a02', 'pf_f05', 'pf_i05', 'pf_f08', 'pf_i08', 'pf_f06', 'pf_i06', 'pf_a06', 'pf_a08', 'pf_i07', 'pf_a07', 'pf_a05'] },
