...
const PHOTO_RATIO = {
  ...
  // ⚠️ 2026-08-15 «세 번째» 재컷으로 다시 잰 값 — 📮 창업자 *"소스 바닥잘렸어"* → *"수정할 거 다 끝난거야?"*
  //    ⛔ PNG 를 갈아끼우면 «비율도 반드시 같이» 고친다(v8.90 에 59개가 어긋난 적이 있다).
  //    🔢 제일 크게 바뀐 것 = fe_290 소고기솥밥 1.0088 → 1.0696 (붙어 있던 「솥」 글자 조각을 뗐다)
  fe_285: 1.1490, fe_286: 1.1463, fe_287: 1.1647, fe_288: 1.1082, fe_289: 1.0957,
  fe_290: 1.0696, fe_291: 1.0763, fe_292: 1.0587, fe_293: 1.0732, fe_294: 0.9974,
  fe_295: 1.1408, fe_296: 1.0185, fe_297: 1.1611, fe_298: 1.1424, fe_299: 1.1139,
