...
//
// 🎨 **색은 창업자가 고른다 — ⏳아래 여섯은 판정 전 자리값이다.**
//   ⛔ 처음엔 「고른 표시」의 노랑(`#f0d98a`)을 «기준»으로 두고 나머지를 거기 맞췄는데,
//      창업자가 바로 풀어줬다 — *"색깔 노랑아니어도 돼.."* (2026-08-06).
...
//    이건 창업자 판정과 무관한 «앱 전체 규칙»이라 후보를 뽑을 때도 지킨다.
export const HL_COLORS = [
  { key: 'yellow', label: '노랑', color: '#f0d98a' },
  { key: 'mint', label: '민트', color: '#b6ddc4' },
  { key: 'sky', label: '하늘', color: '#aecfe4' },
  { key: 'pink', label: '분홍', color: '#efb9c2' },
  { key: 'lilac', label: '라일락', color: '#cdbde2' },
  { key: 'apricot', label: '살구', color: '#f2c6a2' },
]
