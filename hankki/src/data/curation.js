...
const CURATION_ALL = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: '훈제오리', brand: '무무덕', ingredients: '무항생제 오리고기 94%(국내산), 복합조미식품 4.7%[감자전분(국산), 비정제사탕수수당, 양파분말(국산), 정제소금(국산), 마늘분말(국산), 백후추분말, 생강분말, 함초분말 0.246%(국산: 함초 100%)], 양조간장', allergen: '대두, 밀 함유(양조간장) — 라벨 알레르기 줄은 캡처에 없음', checked: '2026-09-17', ingWho: '창업자', matches: ['훈제오리'], benefit: '나온 지 얼마 안 된 신상이에요. 첨가물 없이 깔끔하고 샤브 야채 위에 올려 찜해 먹으면 고소한 다이어트 건강식이 돼요. 자연누리와 또 다른 느낌이라 번갈아 구비해둬요', q: '무무덕 훈제오리', url: 'https://sanjitalk.com/article/161' },
    ],
  },
  {
