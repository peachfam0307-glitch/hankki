...
export const CURATION = [
  {
    ...
    items: [
      ...
      { name: '홍영의 붉은대게 백간장', tag: '백간장', benefit: '붉은대게즙으로 만들어 깔끔하고 깊은 감칠맛이 나요. 국간장보다 색이 옅어 국물색을 해치지 않으면서 간을 맞춰줘서, 맑은국·나물무침·계란찜, 김치찌개 간 맞출 때 살짝 둘러요', q: '홍영의 붉은대게 백간장', mall: 'coupang' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { name: '요리맛샘 굴소스', benefit: '첨가물 없이 국산 재료로 만들었어요. 감칠맛이 깔끔하고 짜지 않아 아이들 볶음요리에도 좋아요. 저는 떨어지면 바로 다시 주문해요', q: '요리맛샘 굴소스', mall: 'coupang', pick: true },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { name: '모에솔트 대파소금', benefit: '대파소금이 유행이라지만 직접 갈아 섞는 건 엄두가 안 났는데 딱 나와줬어요. 국내산 대파 50%에 염도 낮은 소금만으로 만들어 열자마자 대파향이 솔솔. 고기구이·계란후라이·국에 살짝 감칠맛 낼 때 좋아요', q: '모에솔트 대파소금', mall: 'coupang' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { name: '위드잇 쯔유스톡', icon: 'cu_stock_tsuyu', benefit: '성분 좋은 육수 베이스예요. 한 포씩 개별포장이라 필요한 만큼만 쓰기 편하고 유통기한도 넉넉해 구비해두기 좋아요', q: '위드잇 쯔유스톡', mall: 'coupang' },
      { name: '위드잇 치킨스톡', icon: 'cu_stock_chicken', benefit: '한 포씩 톡 넣으면 국물요리가 간편해져요. 성분 좋고 유통기한도 넉넉해 구비해두기 좋아요', q: '위드잇 치킨스톡', mall: 'coupang' },
      { name: '올바른가 요리의정수 해물맛', icon: 'cu_stock_seafood', tag: '가루육수', benefit: '고체(큐브)형 육수는 모양·질감을 잡으려고 변성 성분을 넣어요. 굳이 안 먹어도 되는 첨가물이죠. 이건 가루라 성분이 깨끗하고 육수가 깔끔해요. 꽃게·새우·멸치·다시마로 낸 해물맛이라 김치찌개·국·전골에 한두 봉이면 감칠맛이 딱', q: '올바른가 요리의정수 분말육수 해물맛', mall: 'coupang' },
      { name: '해통령 육수명장 분말', icon: 'cu_stock_seafood', tag: '가루육수', benefit: '올바른가보다 진한 가루육수예요. 올바른가엔 꽃게가, 이건 황태가 들어 국물맛이 깔끔해요. 맛이 달라서 저는 두 가지 구비해두고 국·탕에 두루 써요. 성분도 깔끔한 편이에요', q: '해통령 육수명장 분말', mall: 'coupang' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { name: '문어 비엔나', icon: 'cu_ham_vienna', benefit: '햄·소시지는 첨가물이 많아 쉽게 손이 안 가는데, 이건 성분이 괜찮아 오아시스 장볼 때마다 하나씩 꼭 담는 단골템이에요. 살짝 데쳐 그냥 먹어도 맛있고 모양도 귀여워 아이들이 좋아해요', q: '문어 비엔나', mall: 'oasis' },
      { name: '위드잇 슬라이스햄 슬림', icon: 'cu_ham_slice', benefit: "첨가물 없는 '착한 스팸' 컨셉이에요. (스팸의 찐한 맛을 기대하면 조금 아쉬울 수 있어요) 데리야끼소스에 살짝 구워 무스비에 넣으면 아이 간편식으로 좋아요. 저희 애는 2주 동안 하루 한 개씩 무스비로 먹었어요", q: '위드잇 슬라이스햄 슬림', mall: 'coupang' },
    ],
  },
  {
