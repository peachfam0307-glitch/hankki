...
export const CURATION = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: '올바른가 요리의정수 해물맛', tag: '가루육수', benefit: '고체(큐브)형 육수는 모양·질감을 잡으려고 변성 성분을 넣어요. 굳이 안 먹어도 되는 첨가물이죠. 이건 가루라 성분이 깨끗하고 육수가 깔끔해요. 꽃게·새우·멸치·다시마로 낸 해물맛이라 김치찌개·국·전골에 한두 봉이면 감칠맛이 딱', q: '올바른가 요리의정수 분말육수 해물맛', mall: 'coupang' },
      { name: '해통령 육수명장 분말', tag: '가루육수', benefit: '올바른가보다 진한 가루육수예요. 올바른가엔 꽃게가, 이건 황태가 들어 국물맛이 깔끔해요. 맛이 달라서 저는 두 가지 구비해두고 국·탕에 두루 써요. 성분도 깔끔한 편이에요', q: '해통령 육수명장 분말', mall: 'coupang' },
    ],
  },
  {
    cat: '소스', emoji: '🍯',
