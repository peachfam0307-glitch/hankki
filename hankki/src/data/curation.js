...
const CURATION_ALL = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: '우리밀 또띠아', brand: '남향푸드', matches: ['또띠아'], benefit: '자연드림 또띠아가 첨가물도 없고 데웠을 때 부드러워서 좋았어요. 자연드림이 집 근처에 없다면 이걸로 대용해도 좋아요', q: '남향푸드 우리밀 또띠아', mall: 'coupang', url: 'https://link.coupang.com/a/g3fFJOly0a' },
    ],
  },
  {
