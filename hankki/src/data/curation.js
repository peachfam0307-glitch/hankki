...
export const CURATION = [
  {
    cat: '간장', emoji: '🫗',
    items: [
      { name: '성가정 우리콩 진간장', tag: '진간장', benefit: '국산 우리콩으로 담가 뒷맛이 깔끔해요. 색과 맛이 진해 조림·볶음·불고기처럼 오래 끓이거나 색 내는 요리에 두루 좋아요', q: '성가정 우리콩 진간장' },
  ...
  },
  {
    cat: '된장', emoji: '🥣',
    items: [
      { name: '죽장연 전통된장', benefit: '국산콩과 천일염만으로 담가 깊고 진한 맛이 나요. 맛이 조금 진한 편이라, 백합된장이랑 살짝 섞어 쓰면 훨씬 맛있어요', q: '죽장연 전통된장' },
  ...
  },
  {
    cat: '맛술', emoji: '🍶',
    items: [
      { name: '요리맛샘 맛술', benefit: '성분이 깔끔한 맛술이에요. 살짝 산미가 있지만 잡내를 잡고 감칠맛을 더하는 데 어느 요리에나 잘 맞아요', q: '요리맛샘 맛술' },
    ],
  },
  {
    cat: '굴소스', emoji: '🦪',
    items: [
      { name: '요리맛샘 굴소스', benefit: '첨가물 없이 국산 재료로 만들었어요. 감칠맛이 깔끔하고 짜지 않아 아이들 볶음요리에도 좋아요. 저는 떨어지면 바로 다시 주문해요', q: '요리맛샘 굴소스' },
    ],
  },
  {
    cat: '소금', emoji: '🧂',
    items: [
      { name: '모에솔트 대파소금', benefit: '대파소금이 유행이라지만 직접 갈아 섞는 건 엄두가 안 났는데 딱 나와줬어요. 국내산 대파 50%에 염도 낮은 소금만으로 만들어 열자마자 대파향이 솔솔. 고기구이·계란후라이·국에 살짝 감칠맛 낼 때 좋아요', q: '모에솔트 대파소금' },
    ],
  },
  {
    cat: '스톡·육수', emoji: '🍲',
    items: [
      { name: '위드잇 쯔유스톡', benefit: '성분 좋은 육수 베이스예요. 한 포씩 개별포장이라 필요한 만큼만 쓰기 편하고 유통기한도 넉넉해 구비해두기 좋아요', q: '위드잇 쯔유스톡' },
      { name: '위드잇 치킨스톡', benefit: '한 포씩 톡 넣으면 국물요리가 간편해져요. 성분 좋고 유통기한도 넉넉해 구비해두기 좋아요', q: '위드잇 치킨스톡' },
    ],
  },
  {
    cat: '소스', emoji: '🍯',
  ...
  },
  {
    ...
    items: [
      ...
      { name: '위드잇 슬라이스햄 슬림', benefit: "첨가물 없는 '착한 스팸' 컨셉이에요. (스팸의 찐한 맛을 기대하면 조금 아쉬울 수 있어요) 데리야끼소스에 살짝 구워 무스비에 넣으면 아이 간편식으로 좋아요. 저희 애는 2주 동안 하루 한 개씩 무스비로 먹었어요", q: '위드잇 슬라이스햄 슬림' },
    ],
  },
  {
    cat: '훈제오리', emoji: '🦆',
    items: [
      { name: '자연누리 훈제오리', benefit: '저는 수년째 먹는 재료예요. 소분해 냉동해두면 바쁜 아침에 깻잎이랑 휘리릭 볶아 반찬으로 딱. 처음엔 생소해도 한번 사면 계속 사게 될 거예요', q: '자연누리 훈제오리' },
  ...
  },
  {
    cat: '돼지고기', emoji: '🥩',
    items: [
      { name: '선진포크 한돈 대패목심', benefit: '대패삼겹살보다 기름이 적어 깔끔해요. 소분해 냉동해두면 바쁜 아침에도 금방 구워 낼 수 있어요. 고기 좋아해서 아침에도 고기 찾는 아이 있는 집에 좋아요', q: '선진포크 한돈 대패목심', mall: 'coupang', url: 'https://link.coupang.com/a/fpkYbHl2PI?abTestInfo=100412_group_A' },
    ],
  },
  {
    cat: '국수·면', emoji: '🍜',
    items: [
      { name: '오월햇살 우리밀 유기농국수', benefit: '성분 좋고 쫄깃해서 잔치국수·비빔국수 어디든 편하게 써요. 급할 땐 삶아서 냉면육수만 부어도 시원한 한 그릇 완성!', q: '오월햇살 우리밀 유기농 국수' },
  ...
  },
  {
    cat: '누룽지', emoji: '🍚',
    items: [
      { name: '자연다음 현미누룽지', benefit: '쌀눈 살아있는 국내산 현미누룽지예요. 개별 소포장이라 눅눅해질 걱정 없이 쓰기 편하고, 얇아서 금방 익어 밥하기 귀찮은 날·아침에 밥 없을 때 구원템이에요', q: '자연다음 현미누룽지' },
    ],
  },
  {
    cat: '두유', emoji: '🥛',
    items: [
      { name: '연세 국산콩두유 약콩', benefit: '국산콩으로 만들어 적당한 단맛에 고소하고 느끼하지 않아요. 출출할 때나 아이 간식으로 챙겨주기 좋은, 제 최애 두유예요', q: '연세 국산콩두유 약콩' },
    ],
  },
  {
    cat: '두부', emoji: '🧈',
