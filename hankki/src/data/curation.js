...
export const CURATION = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: '올바른가 요리의정수 해물맛', tag: '가루육수', benefit: '액상 육수는 끓이면 변성 걱정이 있는데, 이건 가루라 그런 게 없어 성분이 깨끗하고 육수가 깔끔해요. 꽃게·새우·멸치·다시마로 낸 해물맛이라 김치찌개·국·전골에 한두 봉이면 감칠맛이 딱. 저는 마늘·국간장 대신 이걸 써요', q: '올바른가 요리의정수 분말육수 해물맛', mall: 'coupang' },
    ],
  },
  {
    cat: '소스', emoji: '🍯',
