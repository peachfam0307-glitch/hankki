...
export const CURATION = [
  ...
  },
  {
    ...
    items: [
      ...
      //   ✅ 2026-08-13 저녁 창업자가 시트를 줬다 → `cu_stock_sagol`.
      //      ⭐ 시트엔 「큰 봉지 500g」과 「개별 소포장」 둘이 왔는데 «개별 소포장»을 골랐다 —
      //         우리 부대찌개 재료가 「2봉」이라 그쪽이 맞다. 큰 봉지 컷은
      //         docs/stickers/큐레이션-2026-08-13/ 에 보관(나중에 큰 것도 쓸 일이 있으면).
      { name: '설성목장 사골육수', matches: ['사골육수', '사골'], icon: 'cu_stock_sagol', tag: '사골육수', benefit: '간이 안 되어 있고 소포장이라 쓰기 편해요. 성분도 깔끔해요', q: '설성목장 사골육수', mall: 'coupang' },
    ],
  },
  {
  ...
  //   ✅ 같은 날 저녁 창업자가 컷을 줘서 `cu_danmuji` 로 넣었다.
  //   ⭐ 그 사이에 「그림이 없으면 유니코드 이모지가 뜨는」 구멍도 같이 막았다(ShopScreen).
  //      다음에 그림 없는 제품을 넣어도 이제 우리 장바구니 아이콘으로 떨어진다.
  {
    cat: '단무지·절임', group: '간편식·간식', emoji: '🥕', icon: 'cu_danmuji',
    items: [
