...
export const CURATION = [
  ...
  },
  {
    cat: '소금', emoji: '🧂',
    items: [
      { name: '모에솔트 대파소금', benefit: '대파소금이 유행이라지만 직접 갈아 섞는 건 엄두가 안 났는데 딱 나와줬어요. 국내산 대파 50%에 염도 낮은 소금만으로 만들어 열자마자 대파향이 솔솔. 고기구이·계란후라이·국에 살짝 감칠맛 낼 때 좋아요', q: '모에솔트 대파소금' , pick: true },
    ],
  },
  {
    cat: '스톡·육수', emoji: '🍲',
