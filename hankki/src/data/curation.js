...
export const CURATION = [
  {
    ...
    items: [
      ...
      { name: '연두 우리콩 요리에센스', matches: ['연두'], tag: '연두', benefit: '노랑뚜껑 «우리콩»이라 성분이 깔끔해요. 국산콩·국산채소로 만들어서 감칠맛만 딱 붙고 뒷맛이 안 남아요. 소금 대신 조금 넣으면 국물이 훨씬 부드러워져서 제가 자주 쓰는 템이에요', url: 'https://www.coupang.com/vp/products/7069991646?itemId=19821201172&vendorItemId=85402664295' },
    ],
  },
  {
