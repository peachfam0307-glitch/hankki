...
const CURATION_ALL = [
  ...
  //   ⏳ **창업자 검수 때 확인할 것 = 「칩이 하나 늘었는데 괜찮은가」**
  {
    ...
    items: [
      ...
      { name: '하바티치즈', brand: '알라', 파트너스없음: true, matches: ['슬라이스'], benefit: '어떤 샌드위치에나 무난하게 잘 어울리는 치즈예요. 코스트코에서 대용량으로 사면 완전 저렴하지만, 급할 때는 쿠팡에서 가끔 주문해요. 저는 글래드랩에 개별 포장해서 냉동실에 넣어두고 써요', url: 'https://www.coupang.com/vp/products/184626081?itemId=528358851&vendorItemId=95181086574', since: '2026-08-17' },
    ],
  },
  {
