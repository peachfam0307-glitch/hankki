...
export const CURATION = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: '이리아다 칼라마타 엑스트라버진 실버틴 250ml', matches: ['올리브유', '올리브오일'], benefit: '밥 지을 때나 샐러드·발사믹 소스처럼 신선한 올리브오일을 그대로 더할 때 써요. 250ml 작은 용량에 틴케이스라 변질 우려도 적고 맛이 깔끔해 재구매템이에요', q: '이리아다 칼라마타 엑스트라버진 올리브유 실버틴', mall: 'coupang' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { name: '무농약콩으로 만든 콩국물', matches: ['콩국물'], benefit: '남편이 콩국수를 좋아해서 여름에 자주 사는 아이템이에요. 국산 대두＋정제수가 끝이에요. 가격도 저렴하고 양도 적어서 한 끼에 딱 끝나요', q: '한살림 무농약콩으로 만든 콩국물', url: HANSALIM_APP },
    ],
  },
  {
