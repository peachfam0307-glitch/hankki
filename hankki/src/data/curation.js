...
const CURATION_ALL = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: '우리밀 또띠아', brand: '남향푸드', matches: ['또띠아'], benefit: '첨가물이 적어서 괜찮아요. 저는 자연드림 또띠아를 즐겨 쓰는데, 이것도 첨가물이 적어서 좋았어요', q: '남향푸드 우리밀 또띠아', mall: 'coupang', url: 'https://link.coupang.com/a/g3fFJOly0a' },
    ],
  },
  {
