...
export const CURATION = [
  ...
  },
  {
    ...
    items: [
      ...
      //   → 「된장」이 붙는 곳은 **된장찌개 1편**뿐이고(실측), 창업자가 **실제로 쓰는 둘 = 맥된장·백합된장**.
      //   ⛔ **죽장연은 안 붙인다** (창업자 *"죽장연 빼고 백합이랑 맥만"*).
  ...
  },
  {
    ...
    items: [
      // ⭐ `matches` 가 없어도 **이미 4편에 붙는다** — 재료줄에 «풀네임»이 그대로 적혀 있으면
      //    `picksForIngredients` 의 ①직접 매칭으로 잡힌다(`matches` 는 ②안전망일 뿐이다).
      //    ⛔ 2026-08-18 에 내가 이걸 못 보고 「안 붙는다·구멍이다」라고 잘못 보고했다. **붙고 있다.**
  ...
  },
  {
    ...
    items: [
      ...
      { name: '자연드림 우리밀 올리고당', matches: ['올리고당'], icon: 'cu_oligo', benefit: '어느 요리나 무난하게 잘 어울려요. 꽤 오래 사용했던 템이에요', q: '자연드림 우리밀 올리고당', since: '2026-08-17' },
    ],
  },
  {
  ...
  //   ⏳ **창업자 검수 때 확인할 것 = 「칩이 하나 늘었는데 괜찮은가」**
  {
    ...
    items: [
      ...
      { name: '알라 하바티치즈', matches: ['슬라이스'], benefit: '어떤 샌드위치에나 무난하게 잘 어울리는 치즈예요. 코스트코에서 대용량으로 사면 완전 저렴하지만, 급할 때는 쿠팡에서 가끔 주문해요. 저는 글래드랩에 개별 포장해서 냉동실에 넣어두고 써요', url: 'https://www.coupang.com/vp/products/184626081?itemId=528358851&vendorItemId=95181086574', since: '2026-08-17' },
    ],
  },
  {
