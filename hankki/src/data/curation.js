...
const CURATION_ALL = [
  ...
  },
  {
    ...
    items: [
      { name: '문어 비엔나', ingredients: '무항생제 돼지고기 89.23%(지방일부사용/국산), 정제수, 대두단백(미국산), 정제소금(국산), 설탕, 포도당, 원나콤비, 발효식초분말, 효모추출물, 복합비프추출물 제이, 폴리인산나트륨, TW-1974(셀러리분말, 정제소금), 블랙페퍼에스엘, 마늘분말, 양파분말, 비타민C-Na, 콜라겐케이싱', allergen: '대두, 돼지고기, 쇠고기 함유', nutrition: '100g당 265kcal · 나트륨 940mg · 탄수화물 5g · 당류 4g · 지방 21g · 트랜스지방 0g · 포화지방 7.2g · 콜레스테롤 70mg · 단백질 14g (총 내용량 240g)', checked: '2026-09-17', ingWho: '창업자', matches: ['비엔나', '소시지'], icon: 'cu_ham_vienna', benefit: '햄·소시지는 첨가물이 많아 쉽게 손이 안 가는데, 이건 성분이 괜찮아 오아시스 장볼 때마다 하나씩 꼭 담는 단골템이에요. 살짝 데쳐 그냥 먹어도 맛있고 모양도 귀여워 아이들이 좋아해요', q: '문어 비엔나', mall: 'oasis' },
