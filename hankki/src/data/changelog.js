...
export const CHANGELOG = [
  ...
  { v: 'v13.94', when: '2026-09-21', user: '홈에서 한끼 인스타그램으로 바로 가요', who: '창업자', asc: true },   // 📷 홈 「한끼 소식」 2/3 · 「한끼 인스타그램」 1/3(창업자가 판을 보며 잡음) · 설정에 「한끼에 DM 보내기」 · insta_go/insta_dm 관문 · 보름달 패드는 상단바 가운데·폰은 조금 위 · ＋ onboard_seen 사람당 10번 나가던 것 고침(Stage→Onboarding). 창업자 「인제 됐다 ㄱㄱ」 · 아이폰 빌드와 같이 연다
