...
export const CHANGELOG = [
  ...
  { v: 'v13.79', when: '2026-09-19', user: null, who: '클로드', asc: false },   // 🔔 서비스워커에 푸시 리스너 둘(push·notificationclick)만 «얹었다» — ⛔유저 눈엔 아직 아무것도 안 보인다(권한 시트도 보내는 쪽도 없다) · 공유받기·캐시는 한 글자도 안 건드림 · 지키는 판 _repro-푸시-0919
