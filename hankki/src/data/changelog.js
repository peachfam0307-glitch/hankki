...
export const CHANGELOG = [
  ...
  { v: 'v13.87', when: '2026-09-20', user: '장바구니에 담으면 알림을 받을지 물어봐요 · 월·수 새 레시피, 토요일 장바구니, 냉장고 유통기한 이틀 전', who: '창업자', asc: false },   // 🔔 허락 시트(pushConsent) ＋ 구독(pushSubscribe) ＋ 워커(worker-push.js) — asc:false = 아이폰(WKWebView)엔 안 뜬다 · 📮 창업자 2026-09-19 23:45 «네가 판단해 리스크나 구멍없는걸로» = 문장 위임 → 유통기한·아이폰은 «안 적었다»(아직 없는 걸 약속하지 않는다)   // 🔔 서비스워커에 푸시 리스너 둘(push·notificationclick)만 «얹었다» — ⛔유저 눈엔 아직 아무것도 안 보인다(권한 시트도 보내는 쪽도 없다) · 공유받기·캐시는 한 글자도 안 건드림 · 지키는 판 _repro-푸시-0919
