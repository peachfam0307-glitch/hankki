...
export const CHANGELOG = [
  ...
  { v: 'v13.93', when: '2026-09-21', user: null, who: '창업자', asc: false },   // 📈 계측 뿌리 고침 — 레꾸자랑 brag_shared 가 이름 덮임으로 0이던 버그 · gtag 전 화면 «줄» · 관문 20개(입구·알림·리뷰·냉장고·장바구니 펼침·자랑 고름·열쇠·받은 선물) · get.html 이 utm 을 Play referrer·App Store ct 에 넘김 ＋ 받기 페이지 전용 GA4 스트림. 유저 화면은 그대로
