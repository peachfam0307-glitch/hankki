...
export const CHANGELOG = [
  ...
  { v: 'v13.95', when: '2026-09-21', user: null, who: '창업자', asc: false },   // 🍽 내 사진 표지가 «그릇에 담긴다» — 기본 그릇 8컷(갈래별 자동 · ⛔창업자 열쇠 ?그릇=1 뒤) · 얹은 그릇 프레임 창에 맞춤 · 할로윈 접시 넷 확정. 유저 화면은 그대로(열쇠 뒤). 창업자 「앱에서 만져볼 수 있어?」
