...
export const CHANGELOG = [
  ...
  // ⏳ v13.73·74 의 「가진 재료」 고침은 «유저 눈에 보인다» — 유저 한 줄을 «창업자에게 받아» 채운다(⛔내가 지으면 안 된다)
  { v: 'v13.74', when: '2026-09-18', user: null, who: '창업자', asc: false },   // 📱 배민·쿠팡이츠·컬리가 앱으로 열린다 ＋ 금액 칸이 칸처럼 보인다
  { v: 'v13.73', when: '2026-09-18', user: null, who: '창업자', asc: false },   // 🍲 「가진 재료」를 본체만 센다(곁가지 뺌) ＋ 식비 줄 고치기
