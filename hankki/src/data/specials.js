...
export const SPECIALS = [
  {
    ...
    sub: '가족들과 따뜻한 한끼',
    from: '2026-09-14',
    // ⭐ [2026-09-14] 9/27 → 9/29 로 늘렸다(창업자 판정).
    //    「나물비빔밥」·「남은 나물 잡채」가 **9/28 에 열리는데** 특집이 9/27 에 끝나면
    //    캐러셀에 실어 놓고 앱에선 못 보는 편이 둘 생긴다. 그 둘이 열리는 날까지 연다.
    until: '2026-09-29',
    ids: [
      ...
      'basic-own-010',              // 🍄 새송이버섯 들깨무침 (연갈색 나물 — 흰 전 뒤, 빨강 앞)
      ...
      // 🍚 연휴 «끝나고» 먹는 둘 — 9/28 에 열린다. 그때부터 이 줄 맨 뒤에 붙는다.
      //    ⭐ 아직 안 열린 편은 «싣는 함수»가 알아서 뺀다 → 9/27 까지는 이 둘이 안 보인다.
      'basic-namul-bibimbap',       // 🍚 나물비빔밥 (9/28~)
      'basic-namul-japchae',        // 🍜 남은 나물 잡채 (9/28~)
