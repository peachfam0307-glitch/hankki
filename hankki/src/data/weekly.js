...
export const WEEKLY = [
  ...
  // ⏳⏳ 아직 안 채운 두 주 (2026-08-13 기준)
  //    · **11/23 = 48 「요즘 뜨는 것」** — ⛔⛔ **내가 못 정한다.** 내가 아는 건 2026년 5월까지라
  //      «2026년 11월에 뭐가 뜨는지»를 모른다. 지어내면 그게 이 칸의 존재 이유를 없앤다.
  //      → **10월 분기 검수 때 창업자와 같이 정한다**(표에도 *"⏳분기 검수 때 채운다"* 라고 적혀 있다).
  //    · **11/30 = 49 「겨울 전골 한 그릇」** — 부대찌개는 «이미 있고» 만둣국·순두부찌개만 쓰면 된다.
  //    ⚠️ 안 채워도 화면은 «안 빈다» — 「오늘 이하 중 가장 최근 한 줄」이 열리므로 11/16(가리비)이 그대로 이어진다.
  //       ⛔ 다만 3주 내리 같은 줄이면 「업데이트 안 하는 앱」으로 읽힌다. 12월치와 같이 채운다.
  //
