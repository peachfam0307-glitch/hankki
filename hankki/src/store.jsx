...
function migrateBasics(saved) {
  ...
  const ICON_FORCE_V88 = {
    '브런치': 'fe_455', '브런치플레이트': 'fe_455', '브런치 플레이트': 'fe_455', '아침플레이트': 'fe_455',
    ...
    '새우 해장 파스타': 'fy_y03', '새우해장파스타': 'fy_y03',
    ...
    '해물오일파스타': 'fe_428', '해물 오일 파스타': 'fe_428', '해물오일 파스타': 'fe_428',   // fe_451 = 알리오올리오(해물이 거의 없다)
