  ...
  const 안내들기본 = {
    ...
    photo: {
      ...
      steps: [
        ...
        // ✂️ [2026-09-13] 옛 글 = 「보일 부분을 정하면 …」 — **자르기를 «전제»한 말이었다.**
        //    창업자 확정으로 통째로 읽기 길에선 자르기 화면을 안 띄우므로, 이 말이 남으면 거짓말이 된다.
        //    ⭐ 그래서 「그대로 읽는다」로 바꾼다 — 글과 실제가 같은 것을 가리켜야 한다(바로 위 원칙 그대로).
        강조('그대로 읽어서 「재료」·「만드는 법」이 채워져요'),
