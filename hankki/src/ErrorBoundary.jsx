  ...
  render() {
    ...
    return (
      <div className="screen" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 14, padding: '0 34px', textAlign: 'center' }}>
        <div style={{ fontSize: 18, fontWeight: 800 }}>화면을 그리다 멈췄어요</div>
        ...
        <button
          ...
          style={{ marginTop: 6, padding: '13px 30px', borderRadius: 999, background: 'var(--brown)', color: '#fff', fontSize: 15.5, fontWeight: 800, border: 0 }}
        >
          다시 열기
        </button>
      </div>
