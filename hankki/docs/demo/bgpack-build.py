...
CHUSEOK = [
 ...
 ('② 조각보', '색천을 이어붙인 보자기. <b>우리 애들과 같은 웜톤</b>으로만 짰다 — 크림·베이지·황토·감빛.',
  ...
  # ⚠️ 첫 판은 보라·초록까지 섞어 **우리 애들과 따로 놀았다**
  #    (창업자: *"조각보 컬러조합이 좀 별로같아.. 우리애들이랑 안어울린달까"*)
  #    → 꼬르곰(주황갈)·펭펭(베이지 트렌치)·가을 소품(황토·단풍)이 **전부 웜톤**이다.
  #      그래서 조각보도 **한 계열 톤온톤**으로 — 크림·베이지·황토·옅은 감빛만 쓴다.
  "linear-gradient(90deg,rgba(198,152,96,.11) 0 25%,transparent 25% 50%,"
  "rgba(176,124,80,.09) 50% 75%,transparent 75%),"
  "linear-gradient(0deg,transparent 0 25%,rgba(214,176,112,.12) 25% 50%,transparent 50% 75%,"
  "rgba(190,140,92,.08) 75%),"
  "linear-gradient(165deg,#faf3e4,#f0e5cf)", 0),
