...
const 판정대기 = {
  // ⏳ [2026-09-25] SNS 새 편 — 빌린 그림 · 창업자 아이콘 판정판(_판-아이콘검수-0925)에 올려 둠 · 새 컷 오면 뺀다 · 가장 이른 편 10/28
  '매콤숙주두부찜': '간장두부조림',
  '황태해장국': '맑은황태국',
  '얼갈이 소고기국': '냉이된장찌개',
  '15분컷 약밥': '찰밥',
  '두부참치조림': '매운두부조림',
  '소고기관자야채볶음': '후추소고기볶음',  // ⏳ 빌린 그림 · 새 컷 대기(10/12)          // ⏳ 빌린 그림 · 새 컷 대기(11/18)
  // ✅ [2026-09-14] 계란후라이조림·버섯전·새우튀김·고등어구이 — 창업자가 새 컷을 뽑아 줘서 «닫혔다»(n3024~n3027)
  '목살조림': '부타노가쿠니',              // ❓부타노가쿠니는 «삼겹» 조림이다
  '고마다래 소스': '참깨소스',             // 같은 것(고마다래 = 참깨 소스)
  '간편갈비조림': '갈비살조림',            // 같은 것
  '어묵탕': '오뎅탕',                     // 같은 것
  '차돌된장찌개': '된장찌개',                  // ❓차돌박이가 안 보인다
