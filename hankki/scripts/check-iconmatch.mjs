...
const 판정대기 = {
  '계란후라이조림': '마약계란장',          // ❓그림은 «삶은 달걀 간장절임» — 계란후라이 조림과 다르다
  '버섯전': '파전',                       // ❓그림에 버섯이 안 보인다
  '새우튀김': '모듬튀김',                  // ❓모듬이라 새우 말고도 많이 들었다
  '고등어구이': '생선구이',                // 아마 같은 것(통생선 구이)
  ...
  '달래장': '달래양념장',                  // 같은 것
  '해물오일파스타': '알리오올리오',         // 🚨창업자가 이미 짚은 자리 — «해물오일파스타는 새우들어간오일파스타»
  '마늘 간장 닭날개조림': '치킨',           // ❓그림은 «튀긴 닭» — 조림이 아니다
