...
// ⛔⛔ [2026-09-04] 「자주 여는 것」이 이 목록에서 빠져 있었다 — **그 갈래만 아무도 안 지키고 있었다.**
//    하필 그게 창업자가 스샷으로 잡아준 갈래고(이름표가 없어 붕 떠 보였다),
//    ProfileScreen 599줄 주석은 아직 「첫 갈래엔 이름표를 안 붙인다」로 남아 있었다.
//    📌 주석이 시키는 대로 떼도 관문이 안 막는 «구멍»이었다. 둘 다 같이 고쳤다.
for (const 이름표 of ['자주 여는 것', '내 것 지키기', '알림과 소식', '함께 만들기', '다시 보기', '화면 꾸미기', '계정과 약관', '앱 정보']) {
