...
const 알림들 = 후보 ? [
  ...
  // 📅 D-2 «따로» — 일정 없는 날(목 9/24) 아침 9시 · 냉장고 줄만 (창업자 2026-09-20 "무조건 -2에는 알려줘야지")
  { 때: '일정 없는 날(목 9/24) 09:00 · D-2 따로', 제목: '한끼', 본문: 거울문장([{ name: '달걀', expiry: '2026-09-26' }], new Date('2026-09-24T09:00:00+09:00')), 언제: '9월 24일' },
]
const 카드 = (n) => `
  <div class="card">
