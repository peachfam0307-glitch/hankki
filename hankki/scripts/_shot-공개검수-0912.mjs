// 🚨📅 **내일(2026-09-12) «저절로» 열리는 것을 «오늘» 검수한다** — 절대원칙 28
//
// 📮 창업자 = *"자동으로 올라가기 전날에 꼭 검수하고 내보내자. **이건 절대원칙.**"* (2026-08-01)
//    ＋ *"좋아 검수판 ㄱㄱ"* (2026-09-04)
//
// 🔢 `release-calendar.mjs --on 2026-09-12` 실측 = **주부의 장바구니 제품 3개**
//    · 올리브오일 — 마야항아리 기버터 260g (쿠팡)
//    · 국수·면 — 샐러드판다 들기름막국수 (쿠팡)
//    · 두부·낫또 — 낫또 (아이쿱 자연드림)
//    📮 뒤 둘은 주소가 없어 「사러가기」가 네이버쇼핑 검색으로 떨어질 뻔했다.
//       창업자가 2026-09-10 에 주소를 줬다 — 막국수는 컬리가 아니라 «쿠팡»이었다(mall 도 고쳤다).
...
//
// 실행: BACKUP=<백업.json> node scripts/_shot-공개검수-0912.mjs
import './_fresh.mjs'
...
const 볼날 = process.env.DAY || '2026-09-12'
const OUT = '/tmp/claude-0/-home-user-hankki/2414fcda-d05a-5b79-84dc-8c748bfda84b/scratchpad/공개검수-0912'
...
const 볼것 = [
  { 이름: '기버터 260g', 갈래: '올리브오일', 몰: '쿠팡' },
  { 이름: '들기름막국수', 갈래: '국수·면', 몰: '쿠팡' },
  { 이름: '낫또', 갈래: '두부·낫또', 몰: '아이쿱' },
]
