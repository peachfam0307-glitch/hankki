...
//
// ⛔⛔⛔ **[상태] 코드는 다 됐지만 «서버(Cloudflare worker)엔 아직 안 올렸다».**
...
chk('🔒⭐ 화면이 「사진 1장에 AI 스캔 1장씩」이라고 정확히 말한다', ed.includes('사진 1장에 AI 스캔 1장씩'), 'true')
chk('🔒⭐ 그 «값» 쪽이 굵다(권하는 말만 굵으면 값이 안 보인다)', /', '사진 1장에 AI 스캔 1장씩', '/.test(ed), 'true')
