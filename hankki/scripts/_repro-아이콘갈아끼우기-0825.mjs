...
const 바랄값 = {
  ...
  'my-9': 'fe_446', 'my-10': 'fe_494', 'my-11': 'fe_42', 'my-12': 'fe_417', 'my-13': 'fe_168',
  'my-14': 'fh_k02', // 새 컷이 없다 = 그대로
  'my-15': 'fe_436', 'my-16': 'fy_y03',            // v11.34 사고 되돌리기
...
for (const r of 옛판) {
  ...
  const 지킴 = ['my-5', 'my-6', 'my-8', 'my-11', 'my-13', 'my-14'].includes(r.id)
