...
const 클래스 = [
  { sel: '.t-sub', 폰: 11.5, 패드: 14.5, 탭: null },
  { sel: '.weekly-kicker', 폰: 12, 패드: 14.5, 탭: null },
  { sel: '.seg', 폰: 13.5, 패드: 15, 탭: '레시피' },
  { sel: '.pill', 폰: 13, 패드: 14.5, 탭: '레시피' },
  { sel: '.grid-card .date', 폰: 11.5, 패드: 13, 탭: '레시피' },
  { sel: '.shop-chip .nm', 폰: 12, 패드: 14.5, 탭: '장보기' },
