...
const 클래스 = [
  { sel: '.t-sub', 폰: 14, 패드: 17, 탭: null },
  { sel: '.weekly-kicker', 폰: 14, 패드: 16.5, 탭: null },
  { sel: '.seg', 폰: 15.5, 패드: 17, 탭: '레시피' },
  { sel: '.pill', 폰: 15, 패드: 16.5, 탭: '레시피' },
  { sel: '.grid-card .date', 폰: 14, 패드: 15.5, 탭: '레시피' },
  { sel: '.shop-chip .nm', 폰: 14, 패드: 16.5, 탭: '장보기' },
