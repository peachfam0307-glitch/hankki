  ...
  if (ev === 'SessionStart') {
    ...
    try {
      ...
      if (nx.length) {
        ...
        if (nx.length > 3) console.log(`   · … 외 ${nx.length - 3}개  (전부 = node hankki/scripts/release-calendar.mjs --brief)`)
