...
VG='/home/user/hankki/hankki/docs/_archive/버전기록-전체.md'
...
echo "▶ Grep·Glob 도 막히나 (2026-08-13 발견한 구멍)"
t "Grep path=_archive 폴더"  2 "{\"tool_name\":\"Grep\",\"tool_input\":{\"pattern\":\"x\",\"path\":\"hankki/docs/_archive\"}}"
t "Grep path=보관소 파일"     2 "{\"tool_name\":\"Grep\",\"tool_input\":{\"pattern\":\"x\",\"path\":\"$VG\"}}"
t "Glob path=_archive"      2 "{\"tool_name\":\"Glob\",\"tool_input\":{\"pattern\":\"*.md\",\"path\":\"hankki/docs/_archive\"}}"
t "Grep path=docs (평소)"    0 "{\"tool_name\":\"Grep\",\"tool_input\":{\"pattern\":\"x\",\"path\":\"hankki/docs\"}}"
t "Grep path 없음 (평소)"    0 "{\"tool_name\":\"Grep\",\"tool_input\":{\"pattern\":\"x\"}}"
echo "▶ 창업자가 지시하면 열리나"
