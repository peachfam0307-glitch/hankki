...
await p.locator('input[placeholder*="살 재료"], input[placeholder*="1990"]').first().fill('두부'); await p.keyboard.press('Enter'); await p.waitForTimeout(400)
...
await p.locator('input[placeholder*="살 재료"], input[placeholder*="1990"]').first().fill('대파'); await p.keyboard.press('Enter'); await p.waitForTimeout(400)
