...
const 장들 = {
  ...
  // ⛔ 꾸미기는 «서랍이 아래»라 위를 남기면 스티커가 통째로 덮인다 → 아래를 남긴다
  '3-레꾸': { 파일: '23-꾸미기-스티커서랍.png', 머리: '레시피 정리? 우린<br>레시피 레꾸해요', 부제: '스티커 붙이고 배경 깔고 · 한 끼가 추억이 돼요', 자리: '50% 100%' },
  ...
  '6-브랜드': { 파일: '10-랜덤카드.png', 머리: '오늘의 한 끼를<br>카드 한 장으로', 부제: '뽑을 때마다 달라지는 카드 · 친구에게 톡', 브랜드: '한끼 · 꼬르곰이 함께해요', 자리: '50% 72%' },
}
