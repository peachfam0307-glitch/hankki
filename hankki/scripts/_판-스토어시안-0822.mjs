...
<div class="card">
  ...
  <hr>
  <p>티격태격하는 저 사춘기 딸도 언젠가,<br>제가 엄마의 밥상을 기억하듯<br><span class="go">오늘의 한 끼를 기억했으면 해요.</span></p>
</div>
...
const 장들 = {
  ...
  '04-장보기': { 파일: '27-장보기-사러가기.png', 머리: '재료는 한 번에<br>사러가기', 부제: '레시피 재료 그대로 톡 · 18년차 주부의 추천템까지' },
  ...
  '07-자랑': { 파일: '10-랜덤카드.png', 머리: '오늘의 한 끼를<br>카드 한 장으로', 부제: '뽑을 때마다 달라지는 카드 · 친구에게 톡', 자리: '50% 42%' },
}
