...
// ── ✏️ 제목 고치기 (창업자 판정) ──
//   ⛔ 원본 JSON 은 안 건드린다 — 그건 창업자 확정본이다. «앱에 나갈 제목»만 여기서 바꾼다.
//   ⭐ id 는 그대로 둔다(`basic-insaeng-budae-jjigae`) — 바꾸면 weekly.js 와 저장값까지 흔들린다.
//      id 는 사람이 보는 글자가 아니라 «가리키는 이름»이라 안 예뻐도 상관없다.
const 제목고침 = {
  '인생 부대찌개': '부대찌개',   // 창업자 2026-08-12 *"인생부대찌개 제목-부대찌개로 바꾸자."*
}
