// 💬🚨 **릴스 자막판 — 앱 화면 위에 얹을 한 줄 자막을 투명 PNG 로 뽑는다**
//
// 📮 창업자 2026-08-29 =
...
//    🚨 시안이 폭발물 처리반이니 띠 «색»만 그 빨강을 쓴다 — 말투까지 무전으로 하면 설명이 사라진다.
