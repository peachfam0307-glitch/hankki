...
컷들 = [
    ('🍂 A 시트', [
        ('낱개-가을접시-2차/pf_ad01.png', 'A1 주름 테 · 고리손잡이'),
        ('낱개-가을접시-2차/pf_ad02.png', 'A2 오벌 · 금테'),
        ('낱개-가을접시-2차/pf_ad03.png', 'A3 오벌 · 초록 굽'),
        ('낱개-가을접시-2차/pf_ad04.png', 'A4 부채 주름 · 노랑 굽'),
    ]),
    ('🍁 B 시트', [
        ('낱개-가을접시-2차/pf_ad05.png', 'B1 둥근 · 단풍'),
        ('낱개-가을접시-2차/pf_ad06.png', 'B2 오벌 · 초록'),
        ('낱개-가을접시-2차/pf_ad07.png', 'B3 오벌 · 골이랑'),
        ('낱개-가을접시-2차/pf_ad08.png', 'B4 물결 · 분홍'),
    ]),
]

음식들 = [
    # zoom = 사진 «속»의 그릇을 잘라내고 음식만 남기는 배율(눈으로 맞췄다)
    # 🍤 [창업자 2026-08-29 제공] 진짜 유저 사진에 가까운 두 장 — **둘 다 「검은 팬·뚝배기」에 담겨 있다.**
    #    ⭐ 그래서 이 판이 진짜로 답하는 질문 = 「그릇 «안»에 또 그릇이 있어도 봐줄 만한가」
    ('음식샘플/감바스.jpg', '감바스', 1.70),      # 빨간 무쇠팬 손잡이·나무도마가 창에 비쳐 더 당겼다
    ('음식샘플/순두부찌개.jpg', '순두부찌개', 1.65),  # 뚝배기 테와 파란 액자선을 잘라낸다
]
