...
const 장면 = [
  // 📮 [09-06 14:48 창업자] *"앞에가 좀 짧아서 대화가 안 읽어 가더라고"* → 대화 컷을 0.9→1.6 으로 늘린다(훅 5.2초). 카드 1.5초는 그대로.
  { chat: 1, dur: 1.6 }, { chat: 2, dur: 1.6 }, { chat: 3, dur: 2.0 },
  { chat: 4, dur: 1.5 }, { chat: 5, dur: 1.5 },
