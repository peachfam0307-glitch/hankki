...
const 고침 = {
  'basic-baechu-kimchi': '참기름 빼고 · 마늘 듬뿍(기호에 따라) · 초피액젓 「간 보며 가감」 ＋ 파운더 레시피 표시',
  'basic-gimjang-suyuk': '창업자 원문 「초초 간단 버전」으로 통째 교체 — 된장·월계수잎·커피가루·소주 뺐다',
  'basic-baechu-jeon': '반죽에 해물가루육수 1큰술 ＋ 새우가루 1작은술(있으면) ＋ 파운더 레시피 표시',
  'basic-manduguk': '초피액젓 1큰술 ＋ 백간장 1큰술 (간은 가감) ＋ ⭐소고기 국거리 빼고 «따로 볶아 올리는 소고기»로. ❓«양념 비율 맞나 봐주세요» — 주신 배합(100g·간장1·초피1/2·설탕1·마늘1/2)을 1L 기준 두 배로 했어요',
  'basic-dongtae-jjigae': '해물가루육수 1봉 ＋ 칼칼한 게 좋으면 청양고추나 고춧가루 더',
  'basic-altang': '해물가루육수 1봉 추가',
  'basic-mugeunji-bokkeum': '해물가루육수 1봉 ＋ 올리고당 빼고 아우노슈가 1큰술 (당도는 가감)',
  'basic-gambas': '백간장 1큰술(소금 대신 · ⛔국간장 빼고 «맛소금») ＋ 해물가루육수 1/2큰술 ＋ 오징어 넣으면 깔라마리 알 아히요',
  ...
  'basic-maesaengi-jeon': '⭐제목이 「매생이 새우전」으로 — 새우를 반죽 위에 하나씩 올려 부친다 ＋ 양파·홍고추 뺐다',
