...
## 결제(유료 유도) — 다음 단계 (미구현)
창업자 결정(2026-07-26 최종): **무료 = 웰컴 20장(첫달) + 매월 5장 + OCR 무제한 / 유료 = 990원 20장팩**(50원/장·원가 2원/건·마진 95%+). 카운트 = 저장당 1건. 상세·근거 = `../docs/AI-레시피추출-기능계획.md` §9-4.
결제(포트원/토스) + KV 크레딧 원장 + 웰컴20·저장당 카운트 = **#54(미구현·출시 게이트)**. **현재 worker = `PER_USER_MONTHLY:5`만 구현**(웰컴·팩·저장당 아직).
