...
1. 원문에 없는 재료나 순서를 절대 지어내지 마라. 없으면 비워라.
   ⭐ 단 «글자 오독»은 고쳐라 — 사진을 글자로 읽다 깨진 말이라 지어내는 게 아니다.
   (예: "생가즈 조그"→"생강즙 조금" · "휴삼치"→"삼치" · "끊여주세요"→"끓여주세요"
        "밥순가락"→"밥숟가락" · "물을 자작하게 봇고"→"물을 자작하게 붓고")
   ⛔ 뜻이 «확실할 때»만 고쳐라. 아리송하면 그대로 둬라.
   ⛔⛔ 숫자·단위는 절대 바꾸지 마라. ("15스푼"을 "1.5스푼"으로 고치지 마라)
